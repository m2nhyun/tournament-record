  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: "h-11 w-full p-0",
        day_button:
          "flex size-11 items-center justify-center rounded-2xl text-sm font-medium transition-colors hover:bg-muted aria-selected:bg-[var(--brand)] aria-selected:text-white",
